...
import { f as formatPrice, b as fetchAllVehicles } from '../chunks/fetchSliders_DENCwVZw.mjs';
/* empty css                                    */
...
const $$Catalogo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Cat\xE1logo - Somos Expertos en veh\xEDculos 4x4", "description": "Cat\xE1logo de veh\xEDculos 4x4" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main> ${renderComponent($$result2, "CatalogoComponent", Catalogo, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/sebaprogrammer/Desktop/proyectos/proyectos-venpu/auto-loa/src/components/catalogo/Catalogo", "client:component-export": "Catalogo" })} </main> ` })}`;
}, "/Users/sebaprogrammer/Desktop/proyectos/proyectos-venpu/auto-loa/src/pages/catalogo.astro", void 0);

const $$file = "/Users/sebaprogrammer/Desktop/proyectos/proyectos-venpu/auto-loa/src/pages/catalogo.astro";
const $$url = "/catalogo";
